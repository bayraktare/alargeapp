        ...
        for table_name, in tables:
            ...
            if regExp.search(s):
                try:
                    tab = QWidget()
                    tab_layout = QVBoxLayout()  
                    tableWidget = QTableWidget() #data table
    ...
    def findSelectedTest(self):
        ...
        if selected_items and self.lastSelectedRow:
            ...
            if file_path:
                ...
                if testType == 'VICAT':
                    if regExp2.search(re.sub(pattern, '', self.lastSelectedRow[0][1])) is None:
                        print("00")
                        return
...
###############################################################
    ...
    def add_component_row(self):
        ...
        input_percent = QLineEdit(self)
        input_percent.setPlaceholderText("Component Percent")  # Added placeholder for percent
        ...
        self.ui.verticalWidget_2.addLayout(hbox)  # Changed to addLayout instead of setLayout
